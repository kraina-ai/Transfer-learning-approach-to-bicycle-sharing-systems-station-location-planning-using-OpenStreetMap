...
from nn_estimators import TensorflowEstimator20, TensorflowEstimator32, TensorflowEstimator50, TensorflowEstimator64, \
                            TensorflowEstimator100, TensorflowEstimator128, TensorflowEstimator200, TensorflowEstimator256, \
                            TensorflowEstimator300, TensorflowEstimator500, TensorflowEstimator36
...
EMB_CLS_PAIRS = [
    (PerCategoryShapeAnalyzerEmbedding300, TensorflowEstimator300),
    (PerCategoryFilteredShapeAnalyzerEmbedding20, TensorflowEstimator20),
    (PerCategoryFilteredShapeAnalyzerEmbedding32, TensorflowEstimator32),
    (PerCategoryFilteredShapeAnalyzerEmbedding50, TensorflowEstimator50),
    (PerCategoryFilteredShapeAnalyzerEmbedding64, TensorflowEstimator64),
    (PerCategoryFilteredShapeAnalyzerEmbedding100, TensorflowEstimator100),
    (PerCategoryFilteredShapeAnalyzerEmbedding128, TensorflowEstimator128),
    (PerCategoryFilteredShapeAnalyzerEmbedding200, TensorflowEstimator200),
    (PerCategoryFilteredShapeAnalyzerEmbedding256, TensorflowEstimator256),
    (PerCategoryFilteredShapeAnalyzerEmbedding300, TensorflowEstimator300),
    (PerCategoryFilteredShapeAnalyzerEmbedding500, TensorflowEstimator500),
    (BaseCountCategoryEmbedding, TensorflowEstimator20),
    (BaseShapeAnalyzerEmbedding, TensorflowEstimator36),
]
    ...
    for resolution in RESOLUTIONS:
        for inbalance_ratio in INBALANCE_RATIOS:
            for processing in X_PROCESSING:
                for (embedding_cls, clf_cls) in EMB_CLS_PAIRS:
...
def check_if_exists(params):
    ...
    client = MongoClient('mongodb://localhost:27017/')
    db = client.osmDataDB
    coll_results = db.experimentsResultsNN
...
def iterate_combination(t):
    ...
    try:
        ...
        results = {}
        with tqdm(total=10 * 10 * len(inbalance_ratios) * len(x_processings), desc=desc, position=None, lock_args=(False,)) as pbar:
